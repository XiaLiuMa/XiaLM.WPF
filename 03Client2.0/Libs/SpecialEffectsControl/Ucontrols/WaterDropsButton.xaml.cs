...
namespace SpecialEffectsControl.Ucontrols
{
    /// <summary>
    /// WaterDropsButton.xaml 的交互逻辑
    /// </summary>
    public partial class WaterDropsButton : UserControl
    {
        public WaterDropsButton()
        {
            InitializeComponent();
        }
        #region 自定义事件
        ...
        public static readonly RoutedEvent ClickRoutedEvent =
            EventManager.RegisterRoutedEvent("Click", RoutingStrategy.Bubble, typeof(EventHandler<WaterDropsButtonRoutedEventArgs>), typeof(WaterDropsButton));
        //CLR事件包装
        ...
        {
            if (sender != null && sender.GetType() == typeof(WaterDropsButton))
            {
                WaterDropsButton uc = (WaterDropsButton)sender;
                uc.Init();
        ...
        {
            WaterDropsButtonRoutedEventArgs args = new WaterDropsButtonRoutedEventArgs(ClickRoutedEvent, this);
            args.Index = -1;
            RaiseEvent(args);
        }
        ...
        private Button GetItemButton(IList<object> itemsSource, int i)
        {
            Button btn = new Button()
            {
                ...
                Style = Resources["WaterDropsButtonGroupButtonStyle"] as Style
            };
    ...
    /// 自定义事件参数类
    /// </summary>
    public class WaterDropsButtonRoutedEventArgs : RoutedEventArgs
    {
        public WaterDropsButtonRoutedEventArgs(RoutedEvent routedEvent, object source) : base(routedEvent, source) { }
