...
{
    /// <summary>
    /// TaskLineFlyout.xaml 的交互逻辑
    /// </summary>
    public partial class TaskLineFlyout : CBaseFlyout
    {
        public TaskLineFlyout()
        {
            InitializeComponent();
        ...
        public TaskLineFlyout(Action refresh) : this()
        {
            Refresh = refresh;
        }
        public TaskLineFlyout(Action refresh, TaskInfoMod taskInfoMod) : this()
        {
        ...
        private void Edit_Click(object sender, RoutedEventArgs e)
        {
            ...
            var flyout = new AddMapLineSubtaskFlyout(map, true, sub);
        ...
        {
            var map = this.cbMapSelect.SelectedItem as MapResource;
            var flyout = new AddMapLineSubtaskFlyout(map);
            flyout.OnAdded += s =>
            {
                var tasks = (DataContext as TaskConfigurationViewModel).SubTaskMods;
                var list = new List<SubTaskMod>();
