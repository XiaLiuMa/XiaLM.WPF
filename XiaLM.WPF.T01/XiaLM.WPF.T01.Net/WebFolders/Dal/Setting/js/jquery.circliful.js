					...
					if($(this).data('icon') != undefined) {
					 ...
					 if($(this).data('type') != undefined) {
						...
						if(type == 'half') {
							...
							$(this).find('.circle-text-half').css({'line-height': 0+ 'px', 'font-size' : size + 'px' });
						} else {
							$(this).append('<span class="circle-text">' + icon + text + '</span>');
							$(this).find('.circle-text').css({'line-height': 0+ 'px', 'font-size' : size + 'px' });
						}
					} else {
						$(this).append('<span class="circle-text">' + icon + text + '</span>');
						$(this).find('.circle-text').css({'line-height':0+ 'px', 'font-size' : size + 'px' });
				...
				if($(this).data('info') != undefined) {
					...
					if($(this).data('type') != undefined) {
						...
						if(type == 'half') { 
							...
							$(this).find('.circle-info-half').css({'line-height': 0 + 'px', });
						} else {
							$(this).append('<span class="circle-info">' + info + '</span>');
							$(this).find('.circle-info').css({'line-height':0 + 'px', });
						}
					} else {
						$(this).append('<span class="circle-info">' + info + '</span>');
						$(this).find('.circle-info').css({'line-height': 0 + 'px', });
